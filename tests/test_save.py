...
def test_init_with_valid_feeds_list(sample_feeds, tmp_path):
    ...
    saver = FeedSaver(feeds_list=sample_feeds, feeds_folder=str(tmp_path))
...
def test_get_filename_from_url(sample_feeds):
    ...
    saver = FeedSaver(feeds_list=sample_feeds)
...
@patch('handler.feeds_save.requests.get')
@patch('handler.feeds_save.FeedSaver._validate_xml')
...
def test_save_xml_with_custom_folder(sample_feeds, tmp_path):
    ...
    saver = FeedSaver(feeds_list=sample_feeds, feeds_folder=str(custom_folder))
